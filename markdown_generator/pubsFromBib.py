...
#
# Takes a set of bibtex of publications and converts them for use with [academicpages.github.io]
# (academicpages.github.io). This is an interactive Jupyter notebook ([see more info here]
...
publist = {
    "proceeding": {
        "file": "../files/bibtex/proceedings.bib",
        "venuekey": "booktitle",
        "venue-pretext": "In the proceedings of ",
        "collection": {"name": "publications", "permalink": "/publication/"},
    },
    # "journal":{
    #     "file": "../files/bibtex/pubs.bib",
    #     "venuekey" : "journal",
    #     "venue-pretext" : "",
